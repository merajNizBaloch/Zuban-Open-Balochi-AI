...
const balochiCopy: Record<string, string> = {
  ...
  "tool.chat.localError": "زُبان مقامی AI شروع کنگءَ ناکام بوت. WebGPU و کافی browser memory لازم اِنت؛ لاگن لازم نہ انت.",
  ...
  "translate.localError": "زُبان مقامی AI شروع کنگءَ ناکام بوت. WebGPU و کافی browser memory لازم اِنت؛ لاگن لازم نہ انت.",
