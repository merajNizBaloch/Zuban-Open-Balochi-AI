...
const balochiCopy: Record<string, string> = {
  ...
  "disclaimer.page.improving.body": "ٹیم و آجو سرچشمگ contributor سرچشمگاں بررسی کنت، غلطیاں درست کنت، ابزار بهتر کنت و بہتر ڈیٹا شامل کنت. زُبان ءِ نتیجہ پروجیکٹ ءِ گشنگ ءَ بدل بوہگ بہ کنت. آشکار اصلاح و دوبارہ آزمایش کنگ ءِ قابل تحقیق اے پروجیکٹ ءِ حصہ انت.",
